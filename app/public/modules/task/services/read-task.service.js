...
export class ReadTask {
  ...
  mountToDoTab(data) {
    ...
    data.map((task) => {
      ...
      deleteButton.onclick = () => this.destroy(task.id);
      ...
      changeToDoingBtn.onclick = () => this.changeStatus(task.id, "doing");
      ...
      changeToDonegBtn.onclick = () => this.changeStatus(task.id, "done");
